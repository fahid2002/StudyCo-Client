...
export function GoogleSignInButton({ mode, onError, onExistingAccount }: GoogleSignInButtonProps) {
  ...
  return (
    <button
      ...
      className="w-full py-3 rounded-xl border border-black/10 dark:border-white/15 font-semibold bg-white dark:bg-[#12151C] hover:border-primary flex items-center justify-center gap-2"
    >
